    ...
    <form class="form-signin">
        ...
        <div class="form-section card-body font-NG">
            <div class="form-group">
                ...
                <input type="text" id="inputID" class="form-control" placeholder="사용할 ID 입력" required autofocus>
            </div>
            <div class="form-group">
                <p class="font-comfortaa">PASSWORD</p>
                <label for="inputPassword" class="sr-only">PASSWORD</label>
                <input type="password" id="inputPassword" class="form-control" placeholder="사용할 패스워드 입력" required>
            </div>
            <div class="form-group">
                <p class="font-comfortaa">CONFIRM PASSWORD</p>
                <label for="inputConfirmPW" class="sr-only">비밀번호 확인</label>
                <input type="password" id="inputConfirmPW" class="form-control" placeholder="사용할 패스워드 입력" required>
            </div>
            <div class="form-group">
                <p class="font-NG">사용자 이름</p>
                <label for="inputUsername" class="sr-only">사용자이름</label>
                <input type="password" id="inputUsername" class="form-control" placeholder="이름(닉네임) 입력" required>
            </div>
        </div>
        <div class="card-footer">
            <button class="btn btn-secondary btn-block" type="submit">회원가입</button>
            <p class="font-NG"><a href="#">뒤로가기</a></p>
        </div>
    </form>
</div>
</body>
